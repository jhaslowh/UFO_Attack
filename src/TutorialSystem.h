...
#define TSTAGE_ABDUCT_COUNT 1
#define TSTAGE_ENEMY_COUNT 2
#define TSTAGE_MOVE 3
#define TSTAGE_ABDUCT_RAY 4
#define TSTAGE_SWITCHING 5
#define TSTAGE_SHOOTING 6
#define TSTAGE_DONE 7
